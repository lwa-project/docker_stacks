AC_DEFUN([AC_PYTHON_DEVEL],[
        ...
        #
        # Check for a version of Python >= 2.7.0
        #
        AC_MSG_CHECKING([for a version of Python >= '2.7.0'])
...
2.7.0. You may need to re-run configure, setting the
...
$ac_distutils_result])
        ...
        AC_SUBST([PYTHON_CPPFLAGS],["$PYTHON_CPPFLAGS -I$numpy_include"])
        ...
        if test -z "$PYTHON_LDFLAGS"; then
                ...
                py_version=`$PYTHON -c "import sys; from distutils.sysconfig import *; \
                        print(get_config_vars('VERSION')[[0]]+sys.abiflags)"`
